...
| 特性 | 其他系统 | Memory-DB |
|------|---------|-----------|
| 文件数 | 80+ Python 文件 | **6 个文件** |
| 容器数 | 4+ Docker 容器 | **1 个容器**（Qdrant）|
| 依赖数 | 20+ 包 | **3 个包**（mcp, qdrant-client, httpx）|
| MCP 工具 | 10+ 个工具 | **3 个工具** |
| Token 成本 | 500+ tokens/轮 | **~236 tokens/轮** |
| 知识图谱 | 必需 | **移除** |
| 全文搜索 | 必需 | **移除** |
| 仪表盘 | 内置 | **移除** |
| 嵌入模型 | 绑定 | **你自己选择** |
...
**结果：** 最小 footprint，最大控制权。你选择嵌入模型，你拥有数据。
